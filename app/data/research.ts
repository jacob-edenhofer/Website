...
export const dphilManuscript: ResearchItem = {
  ...
  abstract: "Governments pursuing decarbonisation face a mismatch between the timing of elections, changes in public attention, and adjustment by firms and households. My DPhil manuscript examines when temporary electoral pressure for climate action can produce lasting increases in policy stringency. Governments choose policies while anticipating whether public attention will persist and how voters will respond as costs become visible. Firms decide whether to invest in cleaner production partly according to whether they expect those policies to continue.\n\nI examine when early investment reduces subsequent costs of compliance, weakens organised opposition, and helps sustain stringent policy after the initial electoral pressure subsides. Delayed adjustment may leave policy vulnerable to dilution or reversal. The manuscript distinguishes the stringency of a policy at adoption from the stringency that can be sustained once its costs become politically consequential. The proposed empirical programme would combine evidence on electoral incentives, sectoral policies, the distribution of costs, and responses by producers.",
  links: [],
};
